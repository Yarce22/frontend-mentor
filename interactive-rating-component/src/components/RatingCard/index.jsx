...
const RatingCard = () => {
  ...
  return (
    <main className={`p-6 lg:py-8 lg:pl-8 lg:pr-10 rounded-2xl max-w-[412px] max-h-[416px] bg-gradient-to-b from-[#232A34] to-[#181E27] ${isQualified ? 'hidden' : 'block'}`}>
        <div className='grid place-items-center w-10 h-10 bg-DarkBlue rounded-full'>
          <img src={starIcon} alt="star-icon" />
        </div>
        <h1 className='py-4 lg:pt-8 lg:pb-4 text-White text-2xl font-bold'>How did we do?</h1>
        ...
        <button className='w-full h-11 bg-Orange rounded-3xl font-bold text-VeryDarkBlue text-sm tracking-widest hover:bg-White' onClick={qualified}>SUBMIT</button>
      </main>
  )
}
