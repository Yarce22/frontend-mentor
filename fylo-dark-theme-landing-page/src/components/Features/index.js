...
const Features = () => {
    ...
    return (_jsx("section", { id: "features", className: "grid grid-cols-1 pt-10 lg:pt-0 lg:px-[280px] place-items-center lg:grid-cols-2 bg-DarkBlue-MainBg", children: FeaturesData.map((feature, index) => (_jsxs("div", { className: "flex flex-col items-center justify-center w-[87.76%] mb-20", children: [_jsx("div", { className: "w-16 h-16 mt-6 mb-8 lg:w-20 lg:h-20", children: _jsx("img", { src: feature.logo, alt: "feature-logo", className: "object-contain w-full h-full" }) }), _jsx("h2", { className: "font-Raleway font-bold text-[18px] lg:text-[20px]", children: feature.title }), _jsx("p", { className: "font-OpenSans text-[14px] text-center mx-1", children: feature.description })] }, index))) }));
};
export { Features };
